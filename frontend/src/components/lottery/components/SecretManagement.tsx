...
export const SecretManagement: FC<SecretManagementProps> = ({
	...
	return (
		<div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
			<h3 className="text-xl font-semibold mb-4">Secret & Allowlist Setup</h3>
			<p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
				Set up your personal allowlist and secret for anonymous prize claiming. Do this once and use for all lotteries!
			</p>
			<div className="flex flex-col gap-4">
				{/* Step 1: Create User Allowlist */}
				<div className="border-b dark:border-gray-700 pb-4">
					<h4 className="font-semibold mb-2">Step 1: Create Your Allowlist (Optional)</h4>
					<p className="text-xs text-gray-600 dark:text-gray-400 mb-3">
						Create your personal allowlist to enable encrypted secret storage on Walrus.
						You'll be automatically added to it. Only needed if you want to use Walrus.
					</p>
					<button
					...
					{allowlistId && (
						<div className="mt-3 p-3 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-700 rounded">
							...
							<div className="space-y-2">
								<div>
									<p className="text-xs font-medium mb-1">Allowlist ID:</p>
				...
				<div className="border-b dark:border-gray-700 pb-4">
					<h4 className="font-semibold mb-2">Step 2: Generate Your Secret</h4>
					<p className="text-xs text-gray-600 dark:text-gray-400 mb-3">
						Generate your secret for anonymous prize claiming. Stored in browser local storage.
					</p>
					<button
			...
			{generatedSecret && (
				<div className="pt-4">
					...
					<p className="text-xs text-gray-600 dark:text-gray-400 mb-3">
						Encrypt your secret with Seal and upload to Walrus for secure,
						decentralized storage. Requires Step 1 allowlist.
					</p>
					<button
						onClick={() => handleEncryptAndUploadSecret(allowlistId, capId)}
						disabled={
							isEncryptingAndUploading || !allowlistId || !capId
						}
			...
			<div className="border-b dark:border-gray-700 pb-4">
				...
				<p className="text-xs text-gray-600 dark:text-gray-400 mb-3">
					If you uploaded your secret to Walrus, you can fetch and decrypt it
					here. Useful for recovering your secret or verifying the upload.
				</p>
				<div className="space-y-3">
					...
					<div>
						...
						<input
							...
							onChange={(e) => setAllowlistIdForDecrypt(e.target.value)}
