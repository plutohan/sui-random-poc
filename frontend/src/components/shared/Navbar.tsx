          ...
          <div className="flex items-center space-x-8">
            ...
            <ul className="flex space-x-2">
              <li>
                <button
                  onClick={() => navigate("/")}
                  className={`px-4 py-2 rounded-lg font-semibold transition-all ${currentPage === "/" || currentPage.startsWith("/lottery/")
              ...
              <li>
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-semibold transition-all ${currentPage === "/wallet"
                    ? "bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-md"
                    : "text-gray-700 dark:text-gray-200 hover:bg-white/20 dark:hover:bg-white/10"
                    }`}
                >
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              <h3 className="text-2xl font-bold text-gradient">How to Play</h3>
              <button
                onClick={() => setShowHowTo(false)}
            ...
            <ol className="list-decimal list-inside space-y-4 text-base text-gray-700 dark:text-gray-300">
              <li className="pl-2">
                <strong>Connect Wallet:</strong> Use the button on the top right to connect your Sui wallet.
              </li>
              <li className="pl-2">
                <strong>Generate Secret:</strong> Go to the Wallet page and generate your one-time secret in "My Secret" to enable anonymous prize claims.
              </li>
              <li className="pl-2">
                <strong>Choose Lottery:</strong> Pick a lottery from the home grid and click a card to open its 3x3 board.
              </li>
              <li className="pl-2">
                <strong>Pick a Slot:</strong> Select an available slot on the board and confirm to submit your pick transaction.
              </li>
              <li className="pl-2">
                <strong>Win & Claim:</strong> If you win, collect your prize directly or claim anonymously using your secret! Creators can also collect their fees.
              </li>
            </ol>
